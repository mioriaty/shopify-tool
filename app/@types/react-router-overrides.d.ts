...
import { PathName } from 'app/routes/types';
import { LiteralUnion, GetLocationState } from './type';
declare module 'react-router' {
  export interface LocationDescriptorObject<P extends string> {
    pathname: LiteralUnion<P, PathName>;
    state: GetLocationState<P>;
    search?: H.Search;
    hash?: H.Hash;
    key?: H.LocationKey;
  }
  ...
  export interface History<P extends PathName> {
    ...
    push<P extends string>(path: LiteralUnion<P, PathName>, state: GetLocationState<P>): void;
    replace<P extends string>(location: LocationDescriptorObject<P>): void;
    replace<P extends string>(path: LiteralUnion<P, PathName>, state: GetLocationState<P>): void;
    go(n: number): void;
    goBack(): void;
    goForward(): void;
