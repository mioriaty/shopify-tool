...
])<{ config: Result; name: string; callback?: () => void }, { item: ClientSmartBarServiceModel }, { message: string }>();
...
export const actionDraftConfig = createAction('@SmartBarPage/actionDraftConfig', (config: Result) => ({ config }));
