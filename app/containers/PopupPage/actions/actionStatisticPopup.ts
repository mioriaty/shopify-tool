...
export const actionUpdateTitlePopup = createAsyncAction([
  '@PopupPage/UpdatePopupTitleRequest',
  '@PopupPage/UpdatePopupTitleSuccess',
  '@PopupPage/UpdatePopupTitleFailure',
])<{ id: string; title: string }, { id: string; title: string }, { id: string; message: string }>();

export const useUpdateTitlePopup = createDispatchAsyncAction(actionUpdateTitlePopup);
