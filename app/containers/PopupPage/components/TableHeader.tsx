...
const TableHeader = () => {
  // selectors
  const selectedIdsState = useSelector(popupPageSelectors.selectedIds);
  const statisticDataState = useSelector(popupPageSelectors.allData);
  ...
  return (
    <View className="popup__table-header" row css={styles.tableHeader}>
